...
ZIDX_DECLARATION = ParticlePropertyDeclaration("z_idx", np.float64)
YIDX_DECLARATION = ParticlePropertyDeclaration("y_idx", np.float64)
XIDX_DECLARATION = ParticlePropertyDeclaration("x_idx", np.float64)
