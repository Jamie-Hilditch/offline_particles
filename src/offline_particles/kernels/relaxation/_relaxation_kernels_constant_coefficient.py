...
def construct_relaxation_kernel_constant_coefficient_constant_target(
    ...
    """Construct a kernel to apply relaxation forcing to a particle property with constant coefficient and target.
    ...
    -------
    BoundKernel
        The constructed kernel for applying relaxation forcing to a particle property with constant coefficient and target.
...
def construct_relaxation_kernel_constant_coefficient_property_target(
    ...
    """Construct a kernel to apply relaxation forcing to a particle property with constant coefficient and property target.
    ...
    -------
    BoundKernel
        The constructed kernel for applying relaxation forcing to a particle property with constant coefficient and property target.
...
def construct_relaxation_kernel_constant_coefficient_scalar_target(
    ...
    """Construct a kernel to apply relaxation forcing to a particle property with constant coefficient and scalar target.
    ...
    -------
    BoundKernel
        The constructed kernel for applying relaxation forcing to a particle property with constant coefficient and scalar target.
...
def construct_relaxation_kernel_constant_coefficient_field_target(
    ...
    """Construct a kernel to apply relaxation forcing to a particle property with constant coefficient and field target.
