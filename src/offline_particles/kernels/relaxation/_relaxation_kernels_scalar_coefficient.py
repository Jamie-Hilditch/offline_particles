...
def construct_relaxation_kernel_scalar_coefficient_constant_target(
    ...
    def kernel_function(
        ...
        return kernel_function_impl(
            ...
            scalars["relaxation_coefficient"],
        )
...
def construct_relaxation_kernel_scalar_coefficient_property_target(
    ...
    if form == "linear":
        ...
        kernel_function_impl = _quadratic_relaxation_scalar_coefficient_property_target()
    else:
        raise ValueError(f"Invalid form: {form}. Must be 'linear' or 'quadratic'.")
...
def construct_relaxation_kernel_scalar_coefficient_scalar_target(
    ...
    if form == "linear":
        ...
        kernel_function_impl = _quadratic_relaxation_scalar_coefficient_scalar_target()
    else:
        raise ValueError(f"Invalid form: {form}. Must be 'linear' or 'quadratic'.")
...
def construct_relaxation_kernel_scalar_coefficient_field_target(
    ...
    match form, array_layout.axes:
        # 1D field target
        case "linear", (axis0,):
            kernel_function_impl = _linear_relaxation_scalar_coefficient_1D_field_target(interpolation_half_width)
        ...
        case "quadratic", (axis0,):
            kernel_function_impl = _quadratic_relaxation_scalar_coefficient_1D_field_target(interpolation_half_width)
            index_declarations = [_INDEX_DECLARATION_MAPPING[axis0]]
            kernel_function = _construct_1d_kernel_function(kernel_function_impl, axis0)
        # 2D field target
        case "linear", (axis0, axis1):
            kernel_function_impl = _linear_relaxation_scalar_coefficient_2D_field_target(interpolation_half_width)
        ...
        case "quadratic", (axis0, axis1):
            kernel_function_impl = _quadratic_relaxation_scalar_coefficient_2D_field_target(interpolation_half_width)
            index_declarations = [_INDEX_DECLARATION_MAPPING[axis0], _INDEX_DECLARATION_MAPPING[axis1]]
            kernel_function = _construct_2d_kernel_function(kernel_function_impl, axis0, axis1)
        # 3D field target
        case "linear", (axis0, axis1, axis2):
            kernel_function_impl = _linear_relaxation_scalar_coefficient_3D_field_target(interpolation_half_width)
            index_declarations = [
        ...
        case "quadratic", (axis0, axis1, axis2):
            kernel_function_impl = _quadratic_relaxation_scalar_coefficient_3D_field_target(interpolation_half_width)
            index_declarations = [
                _INDEX_DECLARATION_MAPPING[axis0],
                _INDEX_DECLARATION_MAPPING[axis1],
                _INDEX_DECLARATION_MAPPING[axis2],
