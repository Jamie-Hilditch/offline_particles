...
def construct_linear_interpolation_kernel(
    idx: Literal["zidx", "xidx", "yidx"], output: str, field: str
) -> KernelBinding:
...
def construct_vertical_interpolation_kernel(output: str, field: str) -> KernelBinding:
    ...
    field : str
        Name of the field data to bind the input field to.
    """
    return construct_linear_interpolation_kernel("zidx", output, field)


def construct_bilinear_interpolation_kernel(indices: tuple[str, str], output: str, field: str) -> KernelBinding:
...
def construct_horizontal_interpolation_kernel(output: str, field: str) -> KernelBinding:
    ...
    field : str
        Name of the field data to bind the input field to.
    """
    return construct_bilinear_interpolation_kernel(("yidx", "xidx"), output, field)


def construct_trilinear_interpolation_kernel(output: str, field: str) -> KernelBinding:
