...
def test_lagrange_3d_rejects_field_smaller_than_stencil() -> None:
    ...
    output = np.zeros(1, dtype=np.float64)
    field = np.ones((4, 4, 3), dtype=np.float64)
