...
class TestGetTimeIndexBoundary:
    def test_time_at_last_element_returns_last_index(self, make_clock) -> None:
    ...
    def test_time_at_first_element_returns_zero(self, make_clock) -> None:
        time_array = np.array([0.0, 1.0, 2.0, 3.0], dtype=np.float64)
        clock = make_clock(time_array, 0.5)
        idx = clock.get_time_index(np.float64(0.0))
        assert idx == pytest.approx(0.0)

    def test_time_in_last_interval(self, make_clock) -> None:
    ...
    def test_time_array_with_two_elements(self, make_clock) -> None:
...
class TestDefaultTimeStop:
    def test_default_time_stop_is_time_array_end_for_forward(self, make_clock) -> None:
    ...
    def test_default_time_stop_is_time_array_start_for_backward(self, make_clock) -> None:
    ...
    def test_default_time_stop_can_be_overridden(self, make_clock) -> None:
    ...
    def test_default_time_stop_can_be_cleared(self, make_clock) -> None:
...
class TestForwardSimulationTimeArrayStop:
    def test_run_stops_at_end_of_time_array_no_explicit_stop(self, make_clock) -> None:
    ...
    def test_run_does_not_raise_at_end_of_time_array(self, make_clock) -> None:
    ...
    def test_run_valid_without_explicit_stopping_condition(self, make_clock) -> None:
...
class TestBackwardSimulationTimeArrayStop:
    def test_run_stops_at_start_of_time_array_no_explicit_stop(self, make_clock) -> None:
    ...
    def test_run_does_not_raise_for_backward_simulation(self, make_clock) -> None:
...
class TestExplicitStoppingConditionsWithTimeArrayBound:
    def test_explicit_iteration_stop_takes_precedence(self, make_clock) -> None:
    ...
    def test_explicit_time_stop_overrides_default(self, make_clock) -> None:
